...
class KnownDevice(Enum):
    # U2P = DeviceInfo(name='U2P', vid=0x0716, pid=0x5030, ep=0x81) # TODO Not working (yet), as its protocol seems different, see https://wiki.cuvoodoo.info/doku.php?id=web-u2 and https://git.cuvoodoo.info/kingkevin/web-u2/src/branch/master/u2_usb.c
